...
Sales performance broken down by:
...
KPIs: Total Revenue, Total pizza sold, Average order value,Total orders & Average pizza per order 
# Tools & Technologies
Power BI — interactive dashboards & visualizations

SQL Server — data extraction, cleaning, aggregation

Excel — initial exploration & quick validation
